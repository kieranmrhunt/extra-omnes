...
- **May 2025:** John Paul II's *Universi Dominici gregis* as subsequently amended; Holy See Press Office bulletins for the twelve general congregations; Vatican News chronology; Gerard O'Connell and Elisabetta Piqué, *The Election of Pope Leo XIV* (2026); contemporary reporting. The roster and public chronology are documented, candidate leanings are inferred, and every tally and voter-by-voter roll is deterministic model output. The reported 134-paper mishap is represented as void and unread rather than assigned an invented count.
